...
public class SwaggerConfig {
    ...
    private static final Contact DEFAULT_CONTACT = new Contact("이수찬", "http://www.hackathon.com", "tncksdl05@gmail.com");

    private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("REST API", "HackaThon REST API", "1.0",
